...
class EmployeesImport implements ToCollection, WithHeadingRow
{
    ...
    public function collection(Collection $rows)
    {
        foreach ($rows as $row) {
            Employee::create([
                ...
                'no_tes' => $row['no_tes'],
                'tgl_tes' => \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject(intval($row['tgl_tes']))->format('Y-m-d'),
                //'tgl_tes' => \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($row['tgl_tes'])->format('Y-m-d'),
                //'tgl_tes' => $this->transformDate($row['tgl_tes']),
                /*
                'tgl_tes' => \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($row['tgl_tes']),
    ...
    {
        //return Carbon::parse($value)->isoformat('Y-m-d H:i');
